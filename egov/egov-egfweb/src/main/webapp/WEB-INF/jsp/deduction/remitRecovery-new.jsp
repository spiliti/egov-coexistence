		...
		<div align="center">
			...
			<table border="0" width="100%">
				<tr>
					...
					<td class="greybox">
						<s:select name="remittanceBean.recoveryId" id="recoveryId" list="dropdownData.recoveryList" listKey="id" listValue="chartofaccounts.glcode+'-'+recoveryName" headerKey="-1" headerValue="----Choose----" value="%{remittanceBean.recoveryId}" />
					</td>
