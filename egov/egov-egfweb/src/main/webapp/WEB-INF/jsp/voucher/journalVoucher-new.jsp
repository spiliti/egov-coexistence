...
<body
	...
	<s:form action="journalVoucher" theme="simple" name="jvcreateform">
		...
		<div class="formmainbox">
			<div class="subheadnew"><s:text name="journal.voucher"/></div>
	...
	function validateJV()
	{
	   //document.getElementById("buttonValue").value=btnval;
		...
		if(vhType =='-1' )	{
			document.getElementById('lblError').innerHTML = "<s:text name='please.select.voucher.subtype'/>";
			document.getElementById('voucherDate').focus();
			return false;
		}
		if(vhDate == '' )	{
			document.getElementById('lblError').innerHTML = "<s:text name='please.select.voucher.date'/>";
			document.getElementById('voucherDate').focus();
			return false;
		}
	    ...
	    if (voucherDate > today) {
	        bootbox.alert("<s:text name='voucher.date.greater.than.today.date'/> ");
	        return false
	    }
		...
		if(vVoucherSubType != 'JVGeneral' && vVoucherSubType != '-1' )	{
			if(document.getElementById('voucherTypeBean.partyName').value == '' ) {
				document.getElementById('lblError').innerHTML = "<s:text name='please.enter.party.name'/> ";
	    ...
	    if (myBillDate > today) {
	        bootbox.alert("<s:text name='bill.date.greater.than.today'/> ");
	        return false
	    }
	    ...
	    if (myPartyBillDate > today) {
	        bootbox.alert("<s:text name='party.date.greater.than.today'/> ");
	        return false
	    }
	...
	// Javascript validation of the MIS Manadate attributes.
		<s:if test="%{isFieldMandatory('vouchernumber')}"> 
			 if(null != document.getElementById('voucherNumber') && document.getElementById('voucherNumber').value.trim().length == 0 ){
				...
				document.getElementById('lblError').innerHTML = "<s:text name='please.enter.voucher.number'/>'";
				return false;
			 }
		 </s:if>
		 <s:if test="%{isFieldMandatory('voucherdate')}"> 
		 	...
		 	<s:if test="%{isFieldMandatory('fund')}"> 
				 if(null != document.getElementById('fundId') && document.getElementById('fundId').value == -1){
					document.getElementById('lblError').innerHTML = "<s:text name='please.select.fund'/>";
					return false;
				 }    
			 </s:if>   
			 ...
			 if(null != document.getElementById('vouchermis.function') && document.getElementById('vouchermis.function').value == -1){
				...
				document.getElementById('lblError').innerHTML = "<s:text name='please.select.function'/>";
				return false;
			 }
		 </s:if>
			<s:if test="%{isFieldMandatory('department')}"> 
				 if(null!= document.getElementById('vouchermis.departmentid') && document.getElementById('vouchermis.departmentid').value == -1){
					...
					document.getElementById('lblError').innerHTML = "<s:text name='please.select.department'/>";
					return false;
				 }
			</s:if>
			<s:if test="%{isFieldMandatory('scheme')}"> 
				 if(null!=document.getElementById('schemeid') &&  document.getElementById('schemeid').value == -1){
					...
					document.getElementById('lblError').innerHTML = "<s:text name='please.select.scheme'/>";
					return false;
				 }
			</s:if>
			<s:if test="%{isFieldMandatory('subscheme')}"> 
				 if(null!= document.getElementById('subschemeid') && document.getElementById('subschemeid').value == -1){
					...
					document.getElementById('lblError').innerHTML = "<s:text name='please.select.subscheme'/>";
					return false;
				 }
			</s:if>
			<s:if test="%{isFieldMandatory('functionary')}"> 
				 if(null!=document.getElementById('vouchermis.functionary') &&  document.getElementById('vouchermis.functionary').value == -1){
					...
					document.getElementById('lblError').innerHTML = "<s:text name='please.select.functionary'/>";
					return false;
				 }
			</s:if>
			<s:if test="%{isFieldMandatory('fundsource')}"> 
				 if(null !=document.getElementById('fundsourceId') &&  document.getElementById('fundsourceId').value == -1){
					...
					document.getElementById('lblError').innerHTML = "<s:text name='please.select.fundsource'/>";
					return false;
				}
			</s:if>
			<s:if test="%{isFieldMandatory('field')}"> 
				 if(null!= document.getElementById('vouchermis.divisionid') && document.getElementById('vouchermis.divisionid').value == -1){
					...
					document.getElementById('lblError').innerHTML = "<s:text name='please.select.field'/>";
					return false;
				 }
			</s:if>
